<template>
	<view v-if="show" class="uni-noticebar" :style="{ background: backgroundColor }" @click="onClick">
		<view ref="textBox" class="uni-noticebar__content-wrapper"
			...
			<view :id="elIdBox" class="uni-noticebar__content"
				...
				<text :id="elId" ref="animationEle" class="uni-noticebar__content-text"
					...
					:style="{color:color, width:wrapWidth+'px',fontSize:fs+'rpx', 'animationDuration': animationDuration, '-webkit-animationDuration': animationDuration ,animationPlayState: webviewHide?'paused':animationPlayState,'-webkit-animationPlayState':webviewHide?'paused':animationPlayState, animationDelay: animationDelay, '-webkit-animationDelay':animationDelay}">{{text}}</text>
			</view>
		</view>
	</view>
</template>
